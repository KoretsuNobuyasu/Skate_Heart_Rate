...
def Get_December(authd_client):
    ...
    heart_df1.to_csv('December_1th.csv')
    ...
    heart_df2.to_csv('December_2th.csv')
    ...
    heart_df3.to_csv('December_3th.csv')
    ...
    heart_df4.to_csv('December_4th.csv')
    ...
    heart_df5.to_csv('December_5th.csv')
    ...
    heart_df6.to_csv('December_6th.csv')
    ...
    heart_df7.to_csv('December_7th.csv')
    ...
    heart_df8.to_csv('December_8th.csv')
    ...
    heart_df9.to_csv('December_9th.csv')
    ...
    heart_df10.to_csv('December_10th.csv')
    ...
    heart_df11.to_csv('December_11th.csv')
    ...
    heart_df12.to_csv('December_12th.csv')
    ...
    heart_df13.to_csv('December_13th.csv')
    ...
    heart_df14.to_csv('December_14th.csv')
    ...
    heart_df15.to_csv('December_15th.csv')
    ...
    heart_df16.to_csv('December_16th.csv')
    ...
    heart_df17.to_csv('December_17th.csv')
    ...
    heart_df18.to_csv('December_18th.csv')
    ...
    heart_df19.to_csv('December_19th.csv')
    ...
    heart_df20.to_csv('December_20th.csv')
    ...
    heart_df21.to_csv('December_21th.csv')
    ...
    heart_df22.to_csv('December_22th.csv')
    ...
    heart_df23.to_csv('December_23th.csv')
    ...
    heart_df24.to_csv('December_24th.csv')
    ...
    heart_df25.to_csv('December_25th.csv')
    ...
    heart_df26.to_csv('December_26th.csv')
    ...
    heart_df27.to_csv('December_27th.csv')
    ...
    heart_df28.to_csv('December_28th.csv')
    ...
    heart_df29.to_csv('December_29th.csv')
    ...
    heart_df30.to_csv('December_30th.csv')
    ...
    heart_df31.to_csv('December_31th.csv')
