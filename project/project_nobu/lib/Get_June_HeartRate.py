...
def Get_June(authd_client):
    ...
    heart_df10.to_csv('June_10th.csv')
    ...
    heart_df11.to_csv('June_11th.csv')
    ...
    heart_df12.to_csv('June_12th.csv')
    """
    # 13日
    ...
    heart_df13.to_csv('June_13th.csv')
    """
    # 14日
    ...
    heart_df14.to_csv('June_14th.csv')
    ...
    heart_df15.to_csv('June_15th.csv')
    ...
    heart_df16.to_csv('June_16th.csv')
    ...
    heart_df17.to_csv('June_17th.csv')
    ...
    heart_df18.to_csv('June_18th.csv')
    ...
    heart_df19.to_csv('June_19th.csv')
    ...
    heart_df20.to_csv('June_20th.csv')
    ...
    heart_df21.to_csv('June_21th.csv')
    ...
    heart_df22.to_csv('June_22th.csv')
    ...
    heart_df23.to_csv('June_23th.csv')
    ...
    heart_df24.to_csv('June_24th.csv')
    ...
    heart_df25.to_csv('June_25th.csv')
    ...
    heart_df26.to_csv('June_26th.csv')
    ...
    heart_df27.to_csv('June_27th.csv')
    ...
    heart_df28.to_csv('June_28th.csv')
    ...
    heart_df29.to_csv('June_29th.csv')
    ...
    heart_df30.to_csv('June_30th.csv')
