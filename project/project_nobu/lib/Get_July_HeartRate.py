...
def Get_July(authd_client):
    ...
    heart_df10.to_csv('July_10th.csv')
    ...
    heart_df11.to_csv('July_11th.csv')
    ...
    heart_df12.to_csv('July_12th.csv')
    ...
    heart_df13.to_csv('July_13th.csv')
    ...
    heart_df14.to_csv('July_14th.csv')
    ...
    heart_df15.to_csv('July_15th.csv')
    ...
    heart_df16.to_csv('July_16th.csv')
    ...
    heart_df17.to_csv('July_17th.csv')
    ...
    heart_df18.to_csv('July_18th.csv')
    ...
    heart_df19.to_csv('July_19th.csv')
    ...
    heart_df20.to_csv('July_20th.csv')
    ...
    heart_df21.to_csv('July_21th.csv')
    ...
    heart_df22.to_csv('July_22th.csv')
    ...
    heart_df23.to_csv('July_23th.csv')
    ...
    heart_df24.to_csv('July_24th.csv')
    ...
    heart_df25.to_csv('July_25th.csv')
    ...
    heart_df26.to_csv('July_26th.csv')
    ...
    heart_df27.to_csv('July_27th.csv')
    ...
    heart_df28.to_csv('July_28th.csv')
    ...
    heart_df29.to_csv('July_29th.csv')
    ...
    heart_df30.to_csv('July_30th.csv')
    ...
    heart_df31.to_csv('July_31th.csv')
