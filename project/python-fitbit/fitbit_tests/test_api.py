...
class CollectionResourceTest(TestBase):
    ...
    def test_all_args(self):
        ...
        self.common_api_test('_COLLECTION_RESOURCE', (resource, base_date=DATE, user_id, data), {}, (url, expected_data), {})
    ...
    def test_no_userid(self):
        ...
        self.common_api_test(
            ...
            (resource, base_date=DATE, user_id, data), {},
            (url, expected_data),
            {}
        )
    ...
    def test_no_data(self):
        ...
        user_id = "bilbo"
        data = None
        url = URLBASE + "/%s/%s/date/%s.json" % (user_id, resource, base_date=DATE)
        self.common_api_test('_COLLECTION_RESOURCE', (resource, base_date=DATE, user_id, data), {}, (url, data), {})
